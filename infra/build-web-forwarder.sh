#!/bin/bash
# =============================================================================
# Build et déploiement du frontend web-forwarder sur AWS ECS
# À exécuter dans AWS CloudShell
# =============================================================================

set -e

SERVICE="web-forwarder"
PORT="3000"
REGION="eu-central-1"
...
aws ecs register-task-definition \
    ...
    --container-definitions "[{\"name\":\"rt-${SERVICE}\",\"image\":\"${ACCOUNT_ID}.dkr.ecr.${REGION}.amazonaws.com/rt-${SERVICE}:latest\",\"portMappings\":[{\"containerPort\":${PORT},\"protocol\":\"tcp\"}],\"essential\":true,\"environment\":[{\"name\":\"NODE_ENV\",\"value\":\"production\"},{\"name\":\"PORT\",\"value\":\"${PORT}\"},{\"name\":\"NEXT_PUBLIC_AFFRET_IA_URL\",\"value\":\"${AFFRET_IA_URL}\"}],\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"/ecs/rt-${SERVICE}\",\"awslogs-region\":\"${REGION}\",\"awslogs-stream-prefix\":\"ecs\",\"awslogs-create-group\":\"true\"}}}]" \
